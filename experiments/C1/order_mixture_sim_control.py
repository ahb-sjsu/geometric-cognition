"""Control for order_mixture_sim.py: clean labels (every pair decided by content)
beside the mixture reading, to n = 102,400, to tell estimator error from noise bias.
...
READINGS = {"clean": (1.0, 0.5), "mixture": (0.16, 0.7375 / 0.84)}
SIZES = [400, 1600, 6400, 25600, 102400]
REPS = 20
...
def main():
    ...
    json.dump(res, open("order_mixture_sim_control.json", "w"), indent=1)
